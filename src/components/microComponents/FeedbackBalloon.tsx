...
export function FeedbackBalloon() {
  return (
    <div className="pb-3">
      <div className="w-[320px] h-[280px] md:scale-75 xl:scale-100 pb-6 font-roboto font-medium shadow-md shadow-black/20 text-black relative flex bg-white px-6 flex-col justify-between items-center rounded-3xl">
